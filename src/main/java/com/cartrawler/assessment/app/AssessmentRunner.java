...
import com.cartrawler.assessment.service.Context;
import com.cartrawler.assessment.service.Logger;
import com.cartrawler.assessment.service.Service;
...
public class AssessmentRunner {
    ...
    public static void main(String[] args) {
        Context context = new Context(CARS.stream().toList());
        Service service = new Service();
        service.runChainOfObjectives(context);

        Logger.log("Input Size : " + CARS.size());
        Logger.log("Output Size : " + context.getCarResults().size());

        Display display = new Display();
        display.render(context.getCarResults());
    }
}